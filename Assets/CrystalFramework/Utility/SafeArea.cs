...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            AddLetterboxBackground();


        }

        private void AddLetterboxBackground()
        {
            ...
            // Calculate the safe area as a percentage of the screen height
            float safeAreaBottom = LastSafeArea.yMin / Screen.height;
            float safeAreaTop = LastSafeArea.yMax / Screen.height;

            // Set RectTransform to cover the bottom letterbox area
            bottomLetterboxBackground.anchorMin = new Vector2(0, 0);
            bottomLetterboxBackground.anchorMax = new Vector2(1, safeAreaBottom);
            bottomLetterboxBackground.offsetMin = Vector2.zero;
            bottomLetterboxBackground.offsetMax = Vector2.zero;

            // Set RectTransform to cover the top letterbox area
            topLetterboxBackground.anchorMin = new Vector2(0, safeAreaTop);
            topLetterboxBackground.anchorMax = new Vector2(1, 1);
            topLetterboxBackground.offsetMin = Vector2.zero;
            topLetterboxBackground.offsetMax = Vector2.zero;


            // Add Image component to display the background color
            Image bottomBackgroundImage = bottomLetterboxBackground.gameObject.AddComponent<Image>();
            bottomBackgroundImage.color = Color.black;

            Image topBackgroundImage = topLetterboxBackground.gameObject.AddComponent<Image>();
