...
public interface ISkillComponent
{
    ...
    void ApplyShape(GameObject skillObject, Vector3 launchPoint, GameObject target, float range, float width, int attackNumber, float projectileangle); //스킬의 형태와 위치를 설정
